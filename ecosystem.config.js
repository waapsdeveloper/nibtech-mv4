...
module.exports = {
  apps: [
    ...
    // =====================================================
    {
      ...
      script: 'artisan',
      args: 'queue:work redis --daemon --queue=api-requests --sleep=1 --tries=3 --timeout=30 --max-jobs=500 --max-time=3600',
    ...
    // =====================================================
    {
      ...
      script: 'artisan',
      args: 'queue:work redis --daemon --queue=default --sleep=3 --tries=3 --timeout=120 --max-jobs=100 --max-time=3600',
    ...
    // =====================================================
    {
      ...
      script: 'artisan',
      args: 'queue:work redis --daemon --queue=listings-sync --sleep=5 --tries=2 --timeout=7200 --max-jobs=10',
