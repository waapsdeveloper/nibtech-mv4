...
class Api_request_model extends Model
{
    ...
    public function push_testing()
    {
        ...
        foreach($requests as $request){
            ...
            if(config('app.url') == 'https://sdpos.nibritaintech.com' && $stock == null && (str_contains(strtolower($datas->BatchID), 'eg') || str_contains(strtolower($datas->TesterName), ', aq') || str_contains(strtolower($datas->TesterName), 'kirti,aq') || str_contains(strtolower($datas->TesterName), 'aqeel'))){
