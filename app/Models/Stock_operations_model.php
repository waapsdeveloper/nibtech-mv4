...
class Stock_operations_model extends Model
{
    ...
    public function new_operation($stock_id, $order_item_id = NULL, $process_id = NULL, $api_request_id = NULL, $old_variation_id = NULL, $new_variation_id = NULL, $description = NULL)
    {
        ...
        if ($find && $find->order_item_id == $order_item_id && $find->process_id == $process_id && $find->api_request_id == $api_request_id && $find->new_variation_id == $new_variation_id && $find->description == $description) {
            return;
        }
