...
// Set download file name
        ...
        if(request('packlist') == 1){
            $filename = 'RMA_List_'.$order->customer->last_name.'_'.$order->reference_id.'_'.$order->order_items->count().'pcs.pdf';
            ...
            $filename = 'RMA_'.$order->customer->last_name.'_'.$order->reference_id.'_'.$order->order_items->count().'pcs.pdf';
