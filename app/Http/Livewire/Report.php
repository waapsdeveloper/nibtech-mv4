    ...
    public function render(Request $request)
    {
        ...
        if(session('user_id') == 1){
            ...
            $b2c_order_items = Order_item_model::whereIn('variation_id', $variation_ids)
                ...
                ->whereIn('status', [3,6])
                ->get();
            $b2c_prices_by_currency = Order_item_model::whereIn('order_id', $b2c_order_ids)
            ...
            dd($b2c_orders->count(), $b2c_order_items->count(), $b2c_order_items->sum('price'), $b2c_prices_by_currency, $b2c_stock_cost);
