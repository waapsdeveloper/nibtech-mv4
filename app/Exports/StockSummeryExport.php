        ...
        foreach($result as $category => $cat){
            ...
            foreach($cat as $brand => $datas){
                ...
                foreach($datas as $data){
                    ...
                    $pdf->MultiCell(80, 0, $variationName, 1, 'L', false, 0, '', '', true);
                    $pdf->MultiCell(12, 0, $data['stock_count'], 1, 'C', false, 0, '', '', true);
                    $pdf->MultiCell(18, 0, number_format($data['average_cost'],2), 1, 'C', false, 0, '', '', true);
