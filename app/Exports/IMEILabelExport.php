        ...
        if($last_sale_order != null){
            if($last_sale_order->order->order_type_id == 3){
                ...
                if($last_sale_order->order->reference_id == 999){
                    ...
                    if($reference == 999){
                        $reference = $last_sale_order->replacement_of->reference_id;
                        if($reference == 999){
                            $reference = $last_sale_order->replacement_of->reference_id;
                            if($reference == 999){
                                $reference = $last_sale_order->replacement_of->reference_id;
            ...
            if($last_order != null && $last_order->delivered_at == null && $last_order->order_type_id == 3){
                $order_l = new Order();
