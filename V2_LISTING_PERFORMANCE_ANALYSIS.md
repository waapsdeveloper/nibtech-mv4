...
1. ✅ Remove auto-expand of marketplace sections
2. ✅ Defer sales data loading (2-3 second delay or on scroll)
3. ✅ Defer marketplace data loading until user expands

### Phase 2: API Optimization
4. ✅ Create batch sales data endpoint
...
2. Auto-expanding all sections (unnecessary UI operations)
3. Loading data that users don't immediately need

**Quick Wins:**
1. Defer sales data loading (save ~2000ms)
2. Defer marketplace data loading (save ~3000ms)
3. Remove auto-expand (save ~1500ms)
