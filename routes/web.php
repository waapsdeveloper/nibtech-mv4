...
Route::get('listed_stock_verification/start_listing_verification', [ListedStockVerification::class,'start_listing_verification'])->name('start_listing_verification');
