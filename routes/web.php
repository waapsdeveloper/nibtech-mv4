...
Route::post('google/refurbed-inbox/attach-ticket', [GoogleController::class, 'attachRefurbedTicket'])->name('google.refurbed_inbox.attach_ticket');
...
Route::post('purchase/add_testing_list/{id}', [Order::class,'add_testing_list'])->name('add_purchase_item');
...
Route::post('purchase/recovery/{id}/paste', [Order::class,'purchase_recovery_paste'])->name('purchase_recovery_paste');
...
Route::get('revert_repair_item/{id}', [Repair::class,'revert_repair_item'])->name('revert_repair_item');
...
Route::get('order/mark_scanned/{id}', [Order::class,'mark_scanned'])->name('mark_scanned');
...
Route::post('inventory/add_verification_imei/{id}', [Inventory::class,'add_verification_imei'])->name('inventory_verification_scan');
...
Route::get('listing/export', [ListingController::class, 'exportFilteredListings'])->name('listing.export');
...
Route::get('get_b2b_customers_json', [Customer::class,'get_b2b_customers_json'])->name('view_customer');
