...
<div class="container-fluid">
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <span class="main-content-title mg-b-0 mg-b-lg-1">{{ $title_page ?? 'Create Stock Deduction Log' }}</span>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('v2.stock-deduction-logs.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select name="variation_id" class="form-control form-select" required>
                                        ...
                                        @foreach($variations as $variation)
                                            <option value="{{ $variation->id }}" {{ old('variation_id') == $variation->id ? 'selected' : '' }}>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select name="marketplace_id" class="form-control form-select" required>
                                        ...
                                        @foreach($marketplaces as $mp)
                                            <option value="{{ $mp->id }}" {{ old('marketplace_id') == $mp->id ? 'selected' : '' }}>{{ $mp->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="order_reference_id" class="form-control" value="{{ old('order_reference_id') }}">
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" name="before_variation_stock" class="form-control" value="{{ old('before_variation_stock', 0) }}" required>
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" name="after_variation_stock" class="form-control" value="{{ old('after_variation_stock', 0) }}" required>
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" name="before_marketplace_stock" class="form-control" value="{{ old('before_marketplace_stock', 0) }}" required>
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" name="after_marketplace_stock" class="form-control" value="{{ old('after_marketplace_stock', 0) }}" required>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select name="deduction_reason" class="form-control form-select" required>
                                        ...
                                        @foreach($deduction_reasons as $key => $label)
                                            <option value="{{ $key }}" {{ old('deduction_reason') == $key ? 'selected' : '' }}>{{ $label }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" name="order_status" class="form-control" value="{{ old('order_status') }}" min="1" max="7">
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" name="old_order_status" class="form-control" value="{{ old('old_order_status') }}" min="1" max="7">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    <label>
                                        <input type="checkbox" name="is_new_order" value="1" {{ old('is_new_order') ? 'checked' : '' }}>
                                        Is New Order
                                    </label>
                                </div>
                            </div>
