					...
					<aside class="app-sidebar">
						...
						<div class="main-sidemenu">
							...
							<ul class="side-menu">
                                ...
                                <li class="slide">
									<a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" width="24" height="24" viewBox="0 0 24 24"><path d="M19 3H5c-1.103 0-2 .897-2 2v14c0 1.103.897 2 2 2h14c1.103 0 2-.897 2-2V5c0-1.103-.897-2-2-2zm0 2 .001 4H5V5h14zM5 11h8v8H5v-8zm10 8v-8h4.001l.001 8H15z"></path></svg>
                                        <span class="side-menu__label">Move Stock To:</span><i class="angle fe fe-chevron-right"></i></a>
									<ul class="slide-menu" style="display: none;">
										<li class="side-menu__label1"><a href="javascript:void(0);">Tables</a></li>
                                        @foreach ($all_grades as $grade)
										    <li><a class="slide-item" href="{{url(session('url').'move_inventory')}}?grade={{$grade->id}}">{{$grade->name}}</a></li>
                                        @endforeach
								    </ul>
								</li>
                                @endif
