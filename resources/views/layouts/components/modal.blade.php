						...
						<div class="modal-body">
							<ul class="row p-3">
								<li class="col-lg-6 mb-2">
									<a href="#" class="d-block p-2 border-bottom">United States</a>
								</li>
								<li class="col-lg-6 mb-2">
									<a href="#" class="d-block p-2 border-bottom">Canada</a>
								</li>
								<li class="col-lg-6 mb-2">
									<a href="#" class="d-block p-2 border-bottom">United Kingdom</a>
								</li>
								<li class="col-lg-6 mb-2">
									<a href="#" class="d-block p-2 border-bottom">Australia</a>
								</li>
							</ul>
						</div>
					</div>
