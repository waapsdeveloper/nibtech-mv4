                    ...
                    <tbody>
                        ...
                        @endphp
                            <tr>
                                ...
                                <button class="btn py-0 btn-link" type="button" data-bs-toggle="modal" data-bs-target="#color_graded_count_modal" onclick="load_color_graded_count({{$summery['pss_id']}},{{$summery['product_id']}})">
                                    <i class="fa fa-eye"></i>
                                </button>
                                </td>
            ...
            <div>
                <div class="card">
                    ...
                    <div class="card-body"><div class="table-responsive">
                        ...
                        <br>
                        {{ $stocks->onEachSide(5)->links() }} {{ __('locale.From') }} {{$stocks->firstItem()}} {{ __('locale.To') }} {{$stocks->lastItem()}} {{ __('locale.Out Of') }} {{$stocks->total()}}
                    </div>
