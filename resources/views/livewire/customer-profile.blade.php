                    ...
                    <table class="table table-bordered table-hover mb-0 text-md-nowrap">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td title="{{ $total_quantity > 0 ? amount_formatter($total_cost / $total_quantity, 2) : amount_formatter(0, 2) }}"><b>{{ amount_formatter($total_cost,2) }}</b></td>
                            </tr>
                        </tfoot>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($transactions as $index => $transaction)
                                            ...
                                            <tr @if ($transaction->status == 2) class="bg-warning" @elseif ($transaction->status == 3) class="bg-lightgreen" @endif>
                                                ...
                                                <td>{{ $transaction->currency_id->sign }}{{ amount_formatter($transaction->amount * ($transaction->exchange_rate ?? 1)) }}</td>
