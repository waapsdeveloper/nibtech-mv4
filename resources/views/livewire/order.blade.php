                                            ...
                                            <tr @if ($order->customer->orders->count() > 1) class="bg-light" @endif>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        {{-- @endif --}}
                                                        <a class="dropdown-item" id="replacement_{{ $item->id }}" href="javascript:void(0);" data-bs-target="#replacement_model" data-bs-toggle="modal" data-bs-reference="{{ $order->reference_id }}" data-bs-item="{{ $item->id }}" data-bs-return="@if($item->stock && $item->stock->last_item() && in_array($item->stock->last_item()->order->order_type_id,[1,4])) 1 @endif"> Replacement </a>
                                                        @if ($order->status >= 3)
                                                        ...
                                                        <tr class="bg-secondary text-white">
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    ...
                                                                    <a class="dropdown-item" id="replacement_{{ $itm->id }}" href="javascript:void(0);" data-bs-target="#replacement_model" data-bs-toggle="modal" data-bs-reference="{{ $order->reference_id }}" data-bs-="{{ $itm->id }}" data-bs-return="@if($itm->stock && $itm->stock->last_item() && in_array($itm->stock->last_item()->order->order_type_id,[1,4])) 1 @endif"> Replacement </a>
                                                                    <a class="dropdown-item" href="https://backmarket.fr/bo_merchant/orders/all?orderId={{ $order->reference_id }}&see-order-details={{ $order->reference_id }}" target="_blank"><i class="fe fe-caret me-2"></i>View in Backmarket</a>
