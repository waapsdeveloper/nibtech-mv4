                                                        ...
                                                        <tr class="bg-secondary text-white">
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    ...
                                                                    <a class="dropdown-item" id="replacement_{{ $itm->id }}" href="javascript:void(0);" data-bs-target="#replacement_model" data-bs-toggle="modal" data-bs-reference="{{ $itm->order->reference_id }}" data-bs-="{{ $itm->id }}" data-bs-return="@if($itm->stock && $itm->check_return && in_array($itm->check_return->order->order_type_id,[1,4])) 1 @endif"> Replacement </a>
                                                                    <a class="dropdown-item" href="https://backmarket.fr/bo_merchant/orders/all?orderId={{ $order->reference_id }}&see-order-details={{ $order->reference_id }}" target="_blank"><i class="fe fe-caret me-2"></i>View in Backmarket</a>
