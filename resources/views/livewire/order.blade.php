                                            ...
                                            <tr @if ($order->customer->orders->count() > 1) class="bg-light" @endif>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        {{-- @endif --}}
                                                        <a class="dropdown-item" id="replacement_{{ $item->id }}" href="javascript:void(0);" data-bs-target="#replacement_model" data-bs-toggle="modal" data-bs-reference="{{ $order->reference_id }}" data-bs-item="{{ $item->id }}" data-bs-return="@if($itm->check_return) 1 @endif"> Replacement </a>
                                                        @if ($order->status >= 3)
