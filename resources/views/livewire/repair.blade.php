    ...
    @section('content')
        ...
        <!-- breadcrumb -->
            <div class="breadcrumb-header justify-content-between">
                ...
                <a href="" onclick="window.open('{{ url('external_not_repair_receive') }}','print_popup','width=800,height=800');" class="btn btn-info"><i class="mdi mdi-minus"></i> Receive Not Repaired Item</a>
                </div>
