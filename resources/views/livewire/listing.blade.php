                                ...
                                <tbody>
                                    ...
                                    @endphp
                                        <tr @if ($listing->buybox != 1) style="background: pink;" @endif>
                                            <td title="{{$listing->id." ".$listing->country_id->name}}"><img src="{{ asset('assets/img/flags/').'/'.strtolower($listing->country_id->code).'.svg' }}" height="15"> {{ $listing->country_id->code }}</td>
                                            @if (session('user')->hasPermission('view_price'))
