                ...
                <div class="col-lg-3 col-xl-3 col-md-3 col-sm-6">
                    ...
                    <select name="customer_id" class="form-control form-select">
                        ...
                        @foreach ($vendors as $id => $customer)
                            <option value="{{ $id }}" @if ($id == request('customer_id')) selected @endif>{{ $customer }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-lg-3 col-xl-3 col-md-3 col-sm-6">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="{{url('delete_rma') . "/" . $order->id }}" onclick="return confirm('Are you sure you want to delete this RMA?');"><i class="fe fe-arrows-rotate me-2 "></i>Delete</a>
