        ...
        <!-- breadcrumb -->
            <div class="breadcrumb-header justify-content-between mb-0" style="border-bottom: 1px solid rgb(216, 212, 212);">
                ...
                <form class="form-inline" id="approveform" style="max-width: 600px" method="POST" action="{{url('wholesale/approve').'/'.$order->id}}">
                    ...
                    <div class="form-floating">
                        <input type="text" list="currencies" id="currency" name="currency" class="form-control wd-100" value="{{$order->currency_id->code}}">
                    ...
                    <div class="form-floating">
                        <input type="text" class="form-control wd-150" id="tracking_number" name="tracking_number" placeholder="Enter Tracking Number" value="{{$order->tracking_number}}" onchange="submitForm()">
                ...
                @if ($order->exchange_rate != null)
                    <br>
                    Exchange Rate: {{ $order->exchange_rate }} ({{ $order->currency_id->code }} )
                ...
                <div class="text-end">
                    <ol class="breadcrumb justify-content-end">
                        ...
                        <li class="breadcrumb-item tx-15"><a href="{{ session('wholesale_previous') ?? url('wholesale') }}">BulkSale</a></li>
            ...
            $('#currency').on('input', function() {
                ...
                if (rate !== undefined) {
                    ...
                    $('#rate').val(''); // Clear the rate field if the currency is not in the list
                                                ...
                                                function editPrice(span, itemId, currentPrice) {
                                                ...
                                                function savePrice(span, itemId, newPrice) {
                                                    ...
                                                    $.ajax({
                                                        ...
                                                        success: function(response) {
                                                            ...
                                                            span.innerHTML = "Price Updated to €" + parseFloat(newPrice).toFixed(2);
                                                        },
                                                        error: function() {
                                                            span.innerHTML = span.dataset.original;
