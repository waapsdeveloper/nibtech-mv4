        ...
        <!-- breadcrumb -->
            <div class="breadcrumb-header justify-content-between mb-0" style="border-bottom: 1px solid rgb(216, 212, 212);">
                ...
                <form class="form-inline" id="approveform" style="max-width: 600px" method="POST" action="{{url('wholesale/approve').'/'.$order->id}}">
                    ...
                    <div class="form-floating">
                        <input type="text" class="form-control wd-150" id="tracking_number" name="tracking_number" placeholder="Enter Tracking Number" value="{{$order->tracking_number}}">
        ...
        <div class="d-flex justify-content-between" style="border-bottom: 1px solid rgb(216, 212, 212);">
            ...
            <div class="p-2">
                ...
                <div>
                    ...
                    <span class="form-check form-switch ms-4 p-2 inline" title="Bypass Wholesale check" onclick="$('#bypass_check').check()">
