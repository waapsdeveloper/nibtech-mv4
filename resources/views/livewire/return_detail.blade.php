                            ...
                            <table class="table table-bordered table-hover mb-0 text-md-nowrap">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($last_ten as $item)
                                        <tr>
                                            <td>{{ $i + 1 }}</td>
                                            <td>{{ $products[$item->variation->product_id] ?? "Variation Model Not added"}} {{$storages[$item->variation->storage] ?? null}} {{$colors[$item->variation->color] ?? null}} {{$grades[$item->variation->grade] ?? "Variation Model Not added" }}</td>
