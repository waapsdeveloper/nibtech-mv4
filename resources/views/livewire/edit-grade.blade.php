    ...
    @section('content')
        ...
        <div class="breadcrumb-header justify-content-between">
            <div class="left-content">
                <span class="main-content-title mg-b-0 mg-b-lg-1">Grade Profile</span>
            </div>
            <div class="justify-content-center mt-2">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item tx-15"><a href="{{url('grade')}}">Grade</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Grade Profile</li>
                </ol>
            </div>
        </div>
        <!-- /breadcrumb -->
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{url('update-grade')}}/{{$grade->id}}" method="POST">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-9 mg-t-5 mg-md-t-0">
                                    <input class="form-control" placeholder="Enter grade's name" name="name" value="{{$grade->name}}" type="text">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h5 class="card-title mg-b-0"> Grade Orders </h5>
                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if ($item->care_id != null)
                                                        <a class="" href="https://backmarket.fr/bo_merchant/grade-request/{{ $item->care_id }}" target="_blank"><strong class="text-danger">Conversation</strong></a>
                                                    @endif
                                                </td>
                                                <td>{{ $item->quantity }}</td>
                                                @if ($order->status == 3)
