                                ...
                                <div class="col-lg-3"> --}}
                                    <div class="col-lg-3 overflow-hidden">
                                        ...
                                        <div class="card-body">
                                            ...
                                            @endforeach
                                            <br>
                                            <h6 class=""><a href="{{url(session('url').'inventory')}}?status=3&stock_status=1&order_type=3" title="Go to orders page">Awaiting <br> Replacements : {{$awaiting_replacement}}</a></h6>
                                        </div>
