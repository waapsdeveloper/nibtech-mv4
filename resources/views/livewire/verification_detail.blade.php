        ...
        <!-- breadcrumb -->
            <div class="breadcrumb-header justify-content-between">
                ...
                <form class="form-inline" id="approveform" method="POST" action="{{url('inventory_verification/ship').'/'.$process->id}}">
                    ...
                    <a class="btn btn-danger" href="{{url('delete_verification') . "/" . $process->id }}" onclick="return confirm('Are you sure you want to delete this verification?');">Delete</a>
                </form>
                ...
                <table class="table table-bordered table-hover mb-0 text-md-nowrap">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td title="{{ $total_quantity > 0 ? amount_formatter($total_cost / $total_quantity, 2) : '0.00' }}"><b>{{ amount_formatter($total_cost, 2) }}</b></td>
