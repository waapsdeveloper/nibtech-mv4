        ...
        <!-- breadcrumb -->
            <div class="breadcrumb-header justify-content-between" style="border-bottom: 1px solid rgb(216, 212, 212);">
                ...
                {{-- <span class="main-content-title mg-b-0 mg-b-lg-1">Purchase</span> --}}
                    ...
                    @else
                    Tracking Number: <a href="https://www.dhl.com/gb-en/home/tracking/tracking-express.html?submit=1&tracking-id={{ urlencode($order->tracking_number) }}" target="_blank"> {{$order->tracking_number}}</a>
                    <br>
