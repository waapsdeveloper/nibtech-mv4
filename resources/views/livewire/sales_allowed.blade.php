...
<div class="toast-container position-fixed top-0 end-0 p-5" style="z-index: 1000">
    ...
    @endif
        ...
        <div class="row">
            <div class="col-md-12" style="border-bottom: 1px solid rgb(216, 212, 212);">
                <center><h4>Sales (Admin)</h4></center>
            </div>
        </div>
        <br>
                                                    ...
                                                    @foreach ($ord->order_items as $ind => $itm)
                                                        ...
                                                        <tr class="bg-secondary text-white">
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    <a class="dropdown-item" href="https://backmarket.fr/bo-seller/orders/all?orderId={{ $ord->reference_id }}&see-order-details={{ $ord->reference_id }}" target="_blank"><i class="fe fe-caret me-2"></i>View in Backmarket</a>
                    ...
                    <div class="modal-body pd-sm-40">
                        ...
                        <form action="{{ url('order/correction') }}" method="POST" onsubmit="if ($('#correction_imei').val() == ''){ if (confirm('Remove IMEI from Order')){return true;}else{event.stopPropagation(); event.preventDefault();};};">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" placeholder="input IMEI / Serial Number" name="correction[imei]" type="text">
                            </div>
                            <div class="form-group">
