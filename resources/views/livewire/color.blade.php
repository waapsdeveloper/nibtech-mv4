    ...
    @section('content')
        <!-- breadcrumb -->
            <div class="breadcrumb-header justify-content-between">
                ...
                <span class="main-content-title mg-b-0 mg-b-lg-1">Color</span>
                </div>
        ...
        <div class="tx-right">
                ...
                <a href="{{url('add-color')}}" class="btn btn-success float-right"><i class="mdi mdi-plus"></i> Add Color</a>
        </div>
        <br>
        @if (session('success'))
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="d-flex justify-content-between">
                            <h4 class="card-title mg-b-0">Colors</h4>
                        </div>
                    </div>
                    <div class="card-body">
