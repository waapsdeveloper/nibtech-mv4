            ...
            <div class="breadcrumb-header justify-content-between">
                ...
                <div class="justify-content-center mt-2">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item tx-15"><a href="{{ session('wholesale_return_previous') ?? url('wholesale_return') }}">BulkSale Return</a></li>
            ...
            <div class="p-2">
                ...
                <form class="form-inline" action="{{ url('add_wholesale_return_item').'/'.$order_id }}" method="POST" id="wholesale_return_item">
                    ...
                    <select name="grade" class="form-control form-select" required>
                        <option value="0" @if(session('grade') == 0) {{'selected'}}@endif>Move to Old Grade</option>
                            ...
                            @endphp
                                        ...
                                        @foreach ($order_items->where('variation_id',$variation->id) as $sale_item)
                                            ...
                                            <tr>
                                                ...
                                                @if (session('user')->hasPermission('view_cost'))
                                                <td>{{ $currency.amount_formatter($stock->sale_item($order_id)->price) }}</td>
                                                @endif
