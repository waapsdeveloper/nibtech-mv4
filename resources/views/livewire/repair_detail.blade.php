                                ...
                                <tbody>
                                    ...
                                    @foreach ($stocks as $item)
                                        ...
                                        <tr class="{{ $danger }}">
                                            ...
                                            <td @if (session('user')->hasPermission('view_cost')) title="Cost Price: {{ $currency.amount_formatter($item->purchase_item->price) ?? "Missing" }}" @endif>
                                                {{ $item->order->customer->first_name }} {{ $currency.amount_formatter($item->purchase_item->price) ?? "Missing" }}
                                            </td>
